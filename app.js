...
function kalkulasi() {
    ...
    // 1. Terima Orang (Realitas Transaksi)
    ...
    // 2. Terima Kotak (Realitas Transaksi)
    ...
    // 3. Master (KEWAJIBAN - Difilter Petugas & Pekan)
    ...
    drawGrafik(bR, kR, bK1, kK1, bK2, kK2); 
    drawIns(bIns);
}
